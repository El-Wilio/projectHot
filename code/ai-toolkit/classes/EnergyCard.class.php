 ...
 *																						|
 * Model Class																			|
 * This class represents one Energy, "within" a card. It should have attributes 		|
 * and methods to allow for any instantiated object to replicate any Energy card in		|
 * format.																				|
 *																						|
